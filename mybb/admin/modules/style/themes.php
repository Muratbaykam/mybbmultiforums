...
if($mybb->input['action'] == "import")
{
	...
	$choices = file_get_contents("http://www.".$domain."/ajaxphp/themedisplay.php");
	
	$actions = '
		
		<input type="hidden" name="import" value="1"/>
		<select name="url" id="url" style="width: 175px;">'.$choices.'</select> 
	
	';
	
	$form_container = new FormContainer($lang->import_a_theme);
	$form_container->output_row("Import a theme", "You can import a theme to your forum if your forum host has added it to the drop down below.", $actions, 'file');
